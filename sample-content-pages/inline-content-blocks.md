...
>
> This block uses `.jcu-block` and `.jcu-block--secondary` for a full-width pale secondary background.
>
...
This example uses `.jcu-partner-logos` and `.jcu-partner-logos--4`, combined with `.jcu-block--secondary`. Images can be plain Markdown images, or linked Markdown images when a logo should link somewhere.
